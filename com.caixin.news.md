# Android Manifest Misconfiguration Leading to Task Hijacking in Caixin News app(com.caixin.news) 
...
![caller.id.phone.number.block](./video/com.caixin.news.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.caixin.news">
