# Android Manifest Misconfiguration Leading to Task Hijacking in Fruit Crush app(com.fruitcrush.fun) 
...
![caller.id.phone.number.block](./video/com.fruitcrush.fun.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.fruitcrush.fun">
