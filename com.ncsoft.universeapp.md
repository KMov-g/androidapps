# Android Manifest Misconfiguration Leading to Task Hijacking in UNIVERSE app(com.ncsoft.universeapp) 
...
![caller.id.phone.number.block](./video/com.ncsoft.universeapp.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.ncsoft.universeapp">
