# Android Manifest Misconfiguration Leading to Task Hijacking in Foresight News app(pro.foresightnews.app) 
...
![caller.id.phone.number.block](./video/pro.foresightnews.app.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="pro.foresightnews.app">
