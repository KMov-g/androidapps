# Android Manifest Misconfiguration Leading to Task Hijacking in Creality Cloud app(com.cxsw.sdprinter) 
...
![caller.id.phone.number.block](./video/com.cxsw.sdprinter.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.cxsw.sdprinter">
