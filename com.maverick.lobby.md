# Android Manifest Misconfiguration Leading to Task Hijacking in Lobby app(com.maverick.lobby) 
...
![caller.id.phone.number.block](./video/com.maverick.lobby.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.maverick.lobby">
