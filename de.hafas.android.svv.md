# Android Manifest Misconfiguration Leading to Task Hijacking in sbg Salzburg app(de.hafas.android.svv) 
...
![caller.id.phone.number.block](./video/de.hafas.android.svv.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="de.hafas.android.svv">
