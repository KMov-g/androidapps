# Android Manifest Misconfiguration Leading to Task Hijacking in StockPlus app(com.dunamu.stockplus) 
...
2. The user uses the malicious app
...
![caller.id.phone.number.block](./video/com.dunamu.stockplus.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.dunamu.stockplus">
