# Android Manifest Misconfiguration Leading to Task Hijacking in SmartRide app(de.hafas.android.vvt) 
...
![caller.id.phone.number.block](./video/de.hafas.android.vvt.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="de.hafas.android.vvt">
