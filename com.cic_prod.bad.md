# Android Manifest Misconfiguration Leading to Task Hijacking in CIC banque app(com.cic_prod.bad) 
...
![caller.id.phone.number.block](./video/com.cic_prod.bad.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.cic_prod.bad">
