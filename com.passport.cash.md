# Android Manifest Misconfiguration Leading to Task Hijacking in Paytend app(com.passport.cash) 
...
![caller.id.phone.number.block](./video/com.passport.cash.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.passport.cash">
