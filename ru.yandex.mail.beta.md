# Android Manifest Misconfiguration Leading to Task Hijacking in Mail app(ru.yandex.mail.beta) 
...
![caller.id.phone.number.block](./video/ru.yandex.mail.beta.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="ru.yandex.mail.beta">
