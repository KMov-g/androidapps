# Android Manifest Misconfiguration Leading to Task Hijacking in CamScanner app(com.intsig.camscanner) 
...
![caller.id.phone.number.block](./video/com.intsig.camscanner.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.intsig.camscanner">
