# Android Manifest Misconfiguration Leading to Task Hijacking in seismic app(com.seismic.doccenter) 
...
![caller.id.phone.number.block](./video/com.seismic.doccenter.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.seismic.doccenter">
