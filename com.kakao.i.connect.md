# Android Manifest Misconfiguration Leading to Task Hijacking in Hey Kakao app(com.kakao.i.connect) 
...
![caller.id.phone.number.block](./video/com.kakao.i.connect.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.kakao.i.connect">
