# Android Manifest Misconfiguration Leading to Task Hijacking in Huuge Box app(com.huuge.game.zjbox) 
...
![caller.id.phone.number.block](./video/com.huuge.game.zjbox.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.huuge.game.zjbox">
