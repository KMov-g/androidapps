# Android Manifest Misconfiguration Leading to Task Hijacking in Maigcal Number app(com.sdmagic.number) 
...
![caller.id.phone.number.block](./video/com.sdmagic.number.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.sdmagic.number">
