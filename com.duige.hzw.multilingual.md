# Android Manifest Misconfiguration Leading to Task Hijacking in Legend of the Phoenix app(com.duige.hzw.multilingual) 
...
![caller.id.phone.number.block](./video/com.duige.hzw.multilingual.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="com.duige.hzw.multilingual">
